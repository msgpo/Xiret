...
'  FileHelper.vb
'  Created by David S
'  Updated on 15.07.2019 - DS (Gain GetApplicationImage)
...
Namespace Helpers
    ...
    Public Class FileHelper
        ...
        Public Shared ReadOnly Hotfix86 As Byte() = My.Resources.Windows6_1_KB2687862_x86
        Public Shared ReadOnly Hotfix64 As Byte() = My.Resources.Windows6_1_KB2687862_x64
...
#Region "Move File"
        ...
        Public Shared Function MoveSafely(ByVal FileToCopy As String, ByVal CopyFileTo As String, Optional Overwrite As Boolean = False) As Integer
            ...
            'I see now that integers can be responded to in a more appropriate manner.
            ...
            Try
                If File.Exists(FileToCopy) Then
                    ...
                    If File.Exists(CopyFileTo) Then
                        ...
                        Dim SourceChecksum = CryptoHelper.GetSha256FromFile(FileToCopy)
                        Dim DestinationChecksum = CryptoHelper.GetSha256FromFile(CopyFileTo)
                        ...
                        Else
                            ...
                            Return 2
                            MessageBox.Show("Checksum fail:" & vbCrLf & SourceChecksum & vbCrLf & DestinationChecksum & vbCrLf & vbCrLf & "The source file was left untouched.", "Core.Helpers.FHMove")
                        End If
                    Else
                        Return 3
                    End If
...
#Region "Install File"
        ...
        Public Shared Function ExecTask(ByVal StartInfo As ProcessStartInfo, ByVal Optional Hush As Boolean = True) As Integer
