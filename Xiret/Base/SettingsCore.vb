...
'  Updated on 09.07.2019 - DS (Added option for custom Imgur Api Key)
...
Module SettingsCore
    ...
    Public SettingsUseCustomImgurApiKey As Integer = 0
    ...
    Public BoolUseCustomIngurApiKey As Boolean = False

    Public StringUserImgurClientId As String = ""
...
#Region "Load Settings"
    ...
    Public Sub LoadSettings()
        ...
        Try
            ...
            Try
                SettingsUseCustomImgurApiKey = CInt(vNode("UseCustomImgurApiKey").InnerText)
                Select Case SettingsUseCustomImgurApiKey
                    Case 0
                        BoolUseCustomIngurApiKey = False
                    Case 1
                        BoolUseCustomIngurApiKey = True
                    Case Else
                        BoolUseCustomIngurApiKey = False
                End Select
            Catch ex As Exception
            ...
            Try
                StringUserImgurClientId = vNode("ImgurAPIClientIdString").InnerText
            Catch ex As Exception
                MessageBox.Show("Settings node malformation in <ImgurAPIClientIdString>.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            End Try
...
#Region "Create Settings"
    Public Sub CreateSettings()
        ...
        XWrite.WriteComment("0:Disable 1:Enable")
        XWrite.WriteElementString("UseCustomImgurApiKey", CStr(SettingsUseCustomImgurApiKey))
        XWrite.WriteComment("User defined Imgur API Client ID")
        XWrite.WriteElementString("ImgurAPIClientIdString", "")
