...
'  Updated on 10.07.2019 - DS (Blocked reading hardware on unrated systems, utilized caching of FHGetLatestXML)
...
#Region "Hardware"
        ...
        Friend Sub ReadXMLHardware()
            ...
            If GetAssessmentValidityInt() = 3 Then 'Block attempts to load hardware on unreated systems
                Exit Sub
            Else
                Try
...
#Region "Routines"
        ...
        Friend Function GetWinsatHardwareXMLInfo(ByVal Node As String, ByVal Inner As String) As String
            ...
            Try
                ...
                Dim xNod As XmlNode
                If Not FHGetLatestXML() = FileLatestFormalXML Then
                    xDoc.Load(FHGetLatestXML)
                Else
                    xDoc.Load(FileLatestFormalXML)
                End If
