...
Namespace Core.WinApi
    ...
    Public Class StrongNameSignatureVerificationA
        ...
        <PreserveSig()>
        Public Shared Function StrongNameSignatureVerificationEx(<MarshalAs(UnmanagedType.LPWStr)> wszFilePath As String, <MarshalAs(UnmanagedType.Bool)> fForceVerification As Boolean,
