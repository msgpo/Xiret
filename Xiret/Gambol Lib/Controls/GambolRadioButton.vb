...
#Region "Properties"
        ...
        Public Overrides Property Text As String
            ...
            Set(value As String)
                MyBase.Text = value
                _TextSize = CreateGraphics().MeasureString(value.ToUpper(), New Font(MyBase.Font.Name, MyBase.Font.Size))
...
#Region "Paint methods"
        ...
        Protected Overrides Sub OnPaint(e As PaintEventArgs)
            ...
            Dim InnerRectangle As RectangleF
            Dim OuterRectangle As RectangleF
            ...
            If Enabled Then
                Using SBrush = New SolidBrush(ForeColor)
                    e.Graphics.DrawString(Text, New Font(Font.Name.ToString, Font.Size), SBrush, TextArea, TextFormat)
                End Using
            Else
