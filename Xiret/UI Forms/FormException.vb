...
'  Xiret project
'  FormException.vb
'  Created by David S on 11.12.2016
...
#Region "Routines"
    ...
    Private Function GenerateSystemData() As String
        ...
        With SBuilder
            ...
            .AppendLine("Channel: " & Program.ProductChannel)
            .AppendLine("SHA512: " & CryptoHelper.GetSha512FromFile(StringPath) & vbCrLf)
            .AppendLine("<-- Operating System -->" & vbCrLf)
            .AppendLine("Name: " & OSHelper.GetWindowsName())
            .AppendLine("Bitness: " & OSHelper.GetWindowsBitness)
            .AppendLine("Kernel: " & OSHelper.GetKernelVersion.ProductVersion())
            .AppendLine("Build: " & OSHelper.GetWindowsBuildLab() & vbCrLf)
            .AppendLine("<-- WinSAT -->" & vbCrLf)
            .AppendLine("Executable Version: " & OSHelper.GetWinsatVersion.ProductVersion)
            .AppendLine("API Version: " & OSHelper.GetWinsatApiVersion.ProductVersion & vbCrLf)
    ...
    Private Function GenerateModuleData() As String
        ...
        For Each LoadedModule As ProcessModule In ThisProc.Modules
            ...
            With SBuilder
                ...
                .AppendLine("SHA512: " & CryptoHelper.GetSha512FromFile(LoadedModule.FileName))
