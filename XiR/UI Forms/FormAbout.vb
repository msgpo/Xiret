...
'  Updated on 04.07.2019 - DS (Cleanup, removed test build numbering from rc1)
'  Updated on 06.07.2019 - DS (Removed dead code)
...
#Region "Load Event"
    ...
    Private Sub FormAbout_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        'Get version and random build number security
